    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900/80 via-indigo-900/70 to-purple-800/80 backdrop-blur-xl backdrop-saturate-150">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-yellow-400/20 to-transparent rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <Card className="relative w-full max-w-2xl mx-auto my-8 bg-white/95 backdrop-blur-md border-0 shadow-2xl shadow-purple-500/25 transform transition-all duration-500 hover:scale-105 min-h-fit">
        ...
        <CardHeader className="text-center pb-6">
          <div className="flex items-center justify-center mb-4">
            <div className="relative">
              <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-yellow-500 rounded-full flex items-center justify-center shadow-lg shadow-purple-500/30">
          ...
          <CardTitle className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-600 to-yellow-600 bg-clip-text text-transparent">
        ...
        <CardContent className="space-y-4 md:space-y-6">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-yellow-100 rounded-full border border-purple-200">
              <Clock className="w-5 h-5 text-purple-600" />
              <span className="font-bold text-purple-700 text-sm md:text-base">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-3 md:p-4 rounded-r-lg">
              <div className="flex items-start gap-3">
                <AlertTriangle className="w-5 h-5 md:w-6 md:h-6 text-red-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-red-800 mb-1 text-sm md:text-base">Critical Disclaimer</h4>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-500 p-3 md:p-4 rounded-r-lg">
              <div className="flex items-start gap-3">
                <Info className="w-5 h-5 md:w-6 md:h-6 text-blue-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-blue-800 mb-1 text-sm md:text-base">Important Notice</h4>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-3 md:p-4">
            <h4 className="font-semibold text-green-800 mb-3 flex items-center gap-2 text-sm md:text-base">
          ...
          <div className="text-center pt-4 sticky bottom-0 bg-white/95 backdrop-blur-sm rounded-t-lg">
            <Button
              ...
              disabled={!canAccess}
              className={`w-full py-3 px-6 text-base md:text-lg font-semibold transition-all duration-300 transform hover:scale-105 ${
                canAccess
